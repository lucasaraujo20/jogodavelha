...
int main(){
    ...
    int cont, l,q, v = 0, i, j, rep = 0, t = 0; // cont = qauntidade de jogadas, l = linha , q  = quadrado , v = vez do jogador
    ...
    do{
        ...
        do{
            ...
            if ( quadrado[l-1][q-1] == 'X' && quadrado[1][1] == ' ') {
            ...
            } else if ( (quadrado[0][0] == 'X'|| quadrado[0][2] == 'X' )&& quadrado[0][1] == ' ' && rep == 0 ){
                quadrado[0][1] = 'O';


                if (quadrado[2][1] != 'X' && quadrado[1][0] == 'X'|| quadrado[1][2] == 'X' || quadrado[2][0] == 'X' || quadrado[2][2] == 'X' ){
                    quadrado[2][1] = 'O';
            ...
            }else if( quadrado[0][0] == 'X' && quadrado[0][1] == 'X' && quadrado[0][2] == 'O' && quadrado[2][0] == 'X' && quadrado[1][0] == ' ' ){ 
                quadrado[1][0] = 'O';


            }else if ((quadrado[2][0] == 'X' && quadrado[2][2] == 'X') &&quadrado[2][1] == ' '&& rep == 0){//

                quadrado[2][1] = 'O';

                if ((quadrado[0][1] != 'X' && quadrado[1][0] == 'X'|| quadrado[1][2] == 'X' || quadrado[0][0] == 'X' || quadrado[0][2] == 'X')){
            ...
            }else if(quadrado[2][0] == 'X' && quadrado[2][1] == 'X' && quadrado[2][2] == 'O' && quadrado[0][0] == 'X' && quadrado[1][2] == ' '){
               quadrado[1][2] = 'O';


            //em cima do meio 1

            }else if ((quadrado[0][0] == 'X' && quadrado[0][1] == 'X' )&&quadrado[0][2] == ' ' && rep == 0){
                quadrado[0][2] = 'O';

                if ((quadrado[2][0] != 'X' && quadrado[1][0] == 'X'|| quadrado[1][2] == 'X' || quadrado[2][2] == 'X' || quadrado[2][1] == 'X')){
                quadrado[2][0] = 'O';
                }
            ...
            }else if ((quadrado[2][0] == 'X' && quadrado[2][1] == 'X')&&quadrado[2][2] == ' '&& rep == 0){
                quadrado[2][2] = 'O';

                if ((quadrado[0][0] != 'X' && quadrado[1][0] == 'X'|| quadrado[1][2] == 'X' || quadrado[0][1] == 'X' || quadrado[0][2] == 'X')){
                quadrado[0][0] = 'O';
                }
            ...
            }else if ((quadrado[0][1] == 'X' && quadrado[0][2] == 'X')&&quadrado[0][0] == ' '&& rep == 0){
                quadrado[0][0] = 'O';

                if ((quadrado[2][2] != 'X' && quadrado[1][0] == 'X'|| quadrado[1][2] == 'X' || quadrado[2][0] == 'X' || quadrado[2][1] == 'X')){
                quadrado[2][2] = 'O';
            ...
            }else if ((quadrado[2][1] == 'X' && quadrado[2][2] == 'X')&&quadrado[2][0] == ' '&& rep == 0){
                quadrado[2][0] = 'O';

                if ((quadrado[0][2] != 'X' && quadrado[1][0] == 'X'|| quadrado[1][2] == 'X' || quadrado[0][0] == 'X' || quadrado[0][1] == 'X')){
                quadrado[0][2] = 'O';
            ...
            else if ( (quadrado[1][0] == 'X' && quadrado[1][2] == 'X' )&& quadrado[0][1] == ' ' && rep == 0 ){
                quadrado[0][1] = 'O';
