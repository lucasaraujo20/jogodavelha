            ...
            do{
                ...
                if(opcao2==1){//criar conta
                    do{
                        ...
                        for(i = 0,verifica = 0;i < j; i++){
                            if(strcmp(usuario[j].nome,usuario[i].nome) == 0){//nome ja exite
                                verifica = 1;
                                break;
                            }
                        }
                        if(verifica == 1){
                            ...
                            printf("\n");
                            compara1 = 0;
                        }else{//criou novo nome,funcionamento do jogo
                            do{
                                printf("\n");
                                imprimelento(new,20);
                                printf("\n");
                                ...
                                setbuf(stdin,NULL);
                                scanf("%d",&opcao3);
                                if(opcao3 == 1){//novo jogo
                                    //funcinamento do jogo
                                }if(opcao3 == 2){//voltar ao menu inicial
                                    opcao3 = 1;
                                    opcao2 = 1;
                                    opcao = 0;
                                    compara1 = 1;
                ...
                }else if(opcao2 == 2){//entra em uma conta
                    do{
                        printf("\n");
                        imprimelento(nome,20);
                        setbuf(stdin,NULL);
                    ...
                    }while(compara1 == 0 && compara2 == 0); 
                }else if(opcao2==3){//voltar
                    opcao = 0;
                    opcao2 = 1;
                }else{//invalido
                    printf("\n");
