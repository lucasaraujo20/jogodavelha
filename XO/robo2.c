        ...
        do{
            ...
            if( ((quadrado[0][0] || quadrado[0][1]|| quadrado[0][2] || quadrado[2][0] || quadrado[2][1] || quadrado[2][2] || quadrado[1][0] || quadrado[1][2]) != ' ') && quadrado[1][1] == ' ' ){
                ...
                quadrado[1][1] = 'O';
                    ...
                    }else if ( quadrado[2][1] == ' ' && quadrado[0][1] == 'O'){
                        quadrado[2][1] = 'O';
                    
                    }else if ( quadrado[2][1] == 'X' && quadrado[1][2] == ' ' & quadrado[2][2] == 'X'){//
                        quadrado[1][2] = 'O';
                    
                    }else if ( quadrado[1][2] == 'X' && quadrado[1][0] == 'O' ){//
                            quadrado[2][2] = 'O';
                    
                    }else if( quadrado[2][1] == 'X' && quadrado[2][2] == ' ' && quadrado[2][0] == ' '){//
                        quadrado[2][2] = 'O';
                    
                    }else if( quadrado[1][2] == 'X' && quadrado[1][0] == ' '){//
                        quadrado[1][0] = 'O';
                    
                    
                    }else if( quadrado[1][0] == 'X' && quadrado[1][2] == ' ' && quadrado[2][0] == ' '){//
                        quadrado[2][0] = 'O';
                    
                    }else if ( quadrado[1][0] == 'X' && quadrado [2][0] == ' '){
                        quadrado[2][0] = 'O';
                    
                    }else if(quadrado[1][2] == ' '  && quadrado[1][0] == 'O'  ){

                        quadrado[1][2] = 'O';

                    }else if ( quadrado [1][0] == ' ' && quadrado [2][1] == ' ' && quadrado[1][2] == 'O' && quadrado[2][2] == 'X'){
                    ...
                    }else if (  quadrado[0][2] == 'X' &&  quadrado[0][1] == 'X' & quadrado[0][0] == ' '){
                            quadrado[0][0] = 'O';


                    }else if ( quadrado[2][2] == 'X' &&  quadrado[1][2] == ' ' ){

                            quadrado[1][2] = 'O';

                    } else if ( quadrado[2][2] == ' ' && quadrado[1][1] == 'O' && quadrado[0][0] == 'O'){

                            quadrado[2][2] = 'O';

                    
                    } else if ( quadrado[2][2] == ' ' && quadrado[0][0] == 'O' && quadrado[2][1] == 'X' ){
                        quadrado[2][2] = 'O'; 

                    }else if( quadrado[2][2] == 'X' && quadrado[1][0] == ' '){
                        quadrado[1][0] = 'O';
                    }

                    // terceira seção x em baixo
