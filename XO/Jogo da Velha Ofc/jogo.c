...
void saveRanking(Player players[], int numjogadores);//salva o rank
void loadRanking(Player players[], int *numjogadores);//carrega ordem do rank
void addPlayer(Player players[], int *numjogadores, char *name);//adc um novo player ao arquivo
void updateWins(Player players[], int numjogadores, char *name);//atualiza vitoria
void updateloss(Player players[], int numjogadores, char *name);//atualiza derrota
...
int main() {
    ...
    loadRanking(players, &numjogadores);
    do{//MENU
        opcao = 0;
        imprimemenu1();
        ...
        if(opcao == 1){//jogar
            do{
                ...
                if(opcao2==1){//jogar 
                    ...
                    setbuf(stdin,NULL);
                    fgets(nick,30,stdin);
                    addPlayer(players,&numjogadores,nick);
                    saveRanking(players, numjogadores);
                    printf("\n");
                        ...
                        if(opcao5 == 1){//jogar novamente
                            if(dificuldade == 1){
                                ...
                                printf(ANSI_COLOR_RED);
                                    if( quadrado[0][0] == 'O' && quadrado[0][1] == 'O' && quadrado[0][2] == 'O'){ cont = 7; printf("\t\nRobo Venceu!\n\n"); updateloss(players, numjogadores, nick); saveRanking(players, numjogadores);};
                                ...
                                printf(ANSI_COLOR_GREEN);
                                    ...
                                    if( quadrado[0][0] == 'X' && quadrado[0][1] == 'X' && quadrado[0][2] == 'X'){ cont = 7; printf("\t\nJogador Venceu!\n\n");updateWins(players, numjogadores, nick); saveRanking(players, numjogadores);}
                                ...
                                if (Empate()) {
                                    ...
                                    printf("\tRobo ganhou!\n\n");
                                    printf(ANSI_COLOR_RESET);
                                    updateloss(players, numjogadores, nick); 
                                    saveRanking(players, numjogadores);
                                } else {
                                    printf(ANSI_COLOR_GREEN);
                                    printf("\tJogador ganhou!\n\n");
                                    printf(ANSI_COLOR_RESET);
                                    updateWins(players, numjogadores, nick); 
                                    saveRanking(players, numjogadores);
                                }
                            }
                            opcao5 = 0;
...
void saveRanking(Player players[], int numjogadores){
...
void loadRanking(Player players[], int *numjogadores){
    ...
    *numjogadores = 0;
    while(fgets(line, sizeof(line), file) != NULL){
        ...
        strncpy(players[*numjogadores].name, name, 50);
        players[*numjogadores].wins = wins;
        players[*numjogadores].loss = loss;
        (*numjogadores)++;
    }
    fclose(file);
}
...
void addPlayer(Player players[], int *numjogadores, char *name){
    if (*numjogadores >= 100) {
    ...
    strncpy(players[*numjogadores].name, name, 50);
    players[*numjogadores].wins = 0;
    players[*numjogadores].loss = 0;
    (*numjogadores)++;
}

void updateWins(Player players[], int numjogadores, char *name){
    for (int i = 0; i < numjogadores; i++) {
...
void updateloss(Player players[], int numjogadores, char *name){
    for (int i = 0; i < numjogadores; i++) {
        if (strcmp(players[i].name, name) == 0) {
            players[i].loss++;
            break;
